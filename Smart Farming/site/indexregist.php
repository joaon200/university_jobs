...
<body>
    ...
    <div class="form-box">
                    <h5 class="title has-text-grey"><i class="fa-solid fa-user-plus"></i></i> Sign In</h5>
                    <?php
                        if(isset($_SESSION['existe'])):
                    ?>
                    <div class="notification is-danger">
                      <h3>ERRO: Usuário já existe.</h3>
                    </div>
                    <?php
                    ...
                    <div class="login-method">
                        <form action="regist.php" method="POST">
                            ...
                            <div class="signin-btn">
                                <div class="child"><h2>I already have an account!</h2></div>
                                <div class="child"><a href="indexlog.php" class="child1"> <i class="fa-solid fa-user"></i>                        Log In</a></div>
                            </div>
                        </form>
                    </div>
    </div>
